			...
			<div class="jumbotron" style="padding-top: 20px;">
				<nav class="navbar navbar-default">
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav">
							<li><a href="normalStarforceForm.jsp">노말 아이템 강화</a></li>
							<li class="active"><a href="normalStarforceForm_cumulativeResult.jsp">노말 아이템 강화 누적 결과</a></li>
						</ul>
					</div>
				</nav>
				<h3 style="text-align: center;">노말 아이템 강화 누적 결과</h3>
				...
				<form class="row g-3">
					...
					<div class="col-12">
						...
						<button id="search_normal" type="button" class="btn btn-primary pull-right">검색</button>
					</div>
				</form>
			</div>
