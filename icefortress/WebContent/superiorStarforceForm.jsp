			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="active"><a href="superiorStarforceForm.jsp">슈페리얼 아이템</a></li>
					</ul>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle"
			...
			<div class="jumbotron" style="padding-top: 20px;">
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
						<ul class="nav navbar-nav">
							<li class="active"><a href="superiorStarforceForm.jsp">슈페리얼 아이템 강화</a></li>
							<li><a href="superiorStarforceForm_cumulativeResult.jsp">슈페리얼 아이템 강화 누적 결과</a></li>
						</ul>
					</div>
				</nav>
				<h3 style="text-align: center;">슈페리얼 아이템 강화</h3>
				...
				<form class="row">
					<div class="col-sm-6 pb-custom-3">
						<label for="numberOfItems" class="form-label">표본 개수</label> <input
							type="number" class="form-control" id="numberOfItems" placeholder="10000"
							required>
					</div>
					<div class="col-sm-6 pb-custom-3">
					...
					<div class="col-12">
						...
						<button id="submit_superior" type="button" class="btn btn-primary pull-right">시행</button>
					</div>
				</form>
			</div>
