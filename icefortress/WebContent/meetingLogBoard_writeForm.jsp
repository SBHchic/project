		...
		<div class="row">
			<form>
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeeee; text-align: center">회의록 작성</th>
						</tr>
					</thead>
					<tbody>
						<tr>
				...
				<button id="submit_write" type="button" name="<%=location %>" class="btn btn-primary pull-right">작성</button>
			</form>
		</div>
	</div>
