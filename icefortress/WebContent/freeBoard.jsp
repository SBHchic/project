...
%>
	...
	ArrayList<FreeBoardDataBean> listAll = manager2.getList();
	...
	ArrayList<FreeBoardDataBean> list = manager2.getListView(listAll, start, pageSize);
	ArrayList<FreeBoardDataBean> noticeList = manager2.getNoticeList();
...
%>
	...
	<div class="container">
		...
		<div style="text-align: right">
			<a href="freeBoard_writeForm.jsp" class="btn btn-primary pull-right">글쓰기</a>
		</div>
	</div>
